Feature: JMS REST API - Test Suite 2
  ...
  Scenario: Producing & Consuming Message
    ...
    And param destination = "queue://dhanaraju.input"
    And header Connection = "Keep-Alive"
    And request "Hi, Karate - JMS from Dhana"
    When method post
    Then status 200
    ...
    * waitForMiliseconds(1000)
    ...
    Given path "/api/message/dhanaraju.input"
    ...
    * print responseType
    * print response
    * match response contains "Hi, Karate - JMS from Dhana"